...
<body>
    <a href="http://localhost/public/landing_page.html" style="color: grey;">Back Home</a>
    <form method="post" action="detail_basic.php">
        <input type="hidden" name="formName" value="autoPost"> <!-- Hidden field to specify the form name -->
